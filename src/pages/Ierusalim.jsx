...
const mainText = [
  ...
  'Что это даёт? Вера не формулирует это как механизм с гарантированным результатом. Она говорит иначе: это живое намерение, вынесенное в место особой силы. Для многих её клиентов молитва у Стены Плача стала поворотным моментом — не потому что "так должно быть по правилам", а потому что что-то менялось. Мягко, но заметно.',
