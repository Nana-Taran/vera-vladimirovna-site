...
const mainText = [
  ...
  'Вера Владимировна работает с картами Таро 35 лет. За это время она провела тысячи раскладов — на отношения, важные решения, переезды, семейные ситуации и жизненные выборы, которые невозможно отложить. Каждый расклад — это не шаблонный ответ, а живая работа с вашей конкретной ситуацией.',
...
const points = [
  ...
  'Рабочая ситуация — стоит ли менять направление, браться за проект, как разрешится конфликт',
  'Жизненный выбор — переезд, решение, которое страшно принять в одиночку',
  'Личное состояние — что вызывает тревогу, на что обратить внимание в повседневных решениях',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Лучше сосредоточиться на одном чётком вопросе или теме — так разбор получается глубже и понятнее. Если тем несколько, Вера подскажет как лучше выстроить работу.',
  },
  {
  ...
  return (
    <div style={{ background: 'var(--bg-deep)', minHeight: '100vh' }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Глубокий расклад карт Таро на ваш вопрос. Отношения, важные решения, жизненный выбор. Онлайн для клиентов из любой страны. 35 лет практики."
        />
      ...
      <noscript>
        Вера Владимировна проводит онлайн-расклады карт Таро для русскоязычных клиентов по всему миру. 35 лет практики, индивидуальный разбор каждой карты применительно к вашей ситуации. Расклады на отношения, важные решения, жизненный выбор и скрытые влияния. Консультации через Telegram и WhatsApp, полная конфиденциальность. Работает онлайн из любой страны.
      </noscript>
      ...
      <section className="py-10 px-4" style={{ background: 'var(--bg-dark)' }}>
        <div className="max-w-[900px] mx-auto">
          ...
          >
            Вера Владимировна проводит онлайн-расклады карт Таро для русскоязычных клиентов по всему миру. 35 лет практики, индивидуальный разбор каждой карты применительно к вашей ситуации. Расклады на отношения, важные решения, жизненный выбор и скрытые влияния. Консультации через Telegram и WhatsApp, полная конфиденциальность.
          </p>
        </div>
      </section>
