...
export default function UkraintsvGretsii() {
  return (
    <div style={{ background: 'var(--bg-deep)', minHeight: '100vh' }}>
      <Helmet>
        <title>Ясновидящая для украинцев в Греции — Вера Владимировна</title>
        <meta name="description" content="Онлайн-консультация ясновидящей для украинцев в Греции. 35 лет практики. Таро, ясновидение, тёплая поддержка на родном языке." />
        <link rel="canonical" href="https://veravladimirovna.com/ukraintsy-v-gretsii" />
      ...
      <noscript>
        Вера Владимировна — ясновидящая онлайн для украинцев в Греции. 35 лет практики, потомственный дар. Таро, ясновидение, помощь в отношениях, поддержка в трудный период. Работает дистанционно, тепло и без запугивания. Конфиденциально.
      </noscript>
      <Navbar />
        ...
        <div className="max-w-[900px] mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="font-bebas leading-none mb-4" style={{ color: 'var(--text-white)', fontSize: 'clamp(32px, 5vw, 54px)' }}>
              ЯСНОВИДЯЩАЯ ОНЛАЙН<br />ДЛЯ УКРАИНЦЕВ В ГРЕЦИИ
            </h1>
            <p className="font-lobster mb-8" style={{ color: 'var(--accent)', fontSize: 'clamp(18px, 2.5vw, 28px)', lineHeight: 1.3 }}>
              Афины и тёплое море — но вопросы сердца остаются такими же.
            </p>
          </motion.div>
        </div>
      </section>
      <section className="py-16 px-4" style={{ background: 'var(--bg-dark)' }}>
        <div className="max-w-[900px] mx-auto space-y-5 font-lato text-base leading-relaxed" style={{ color: 'var(--text-beige)', fontWeight: 300 }}>
          <p>Греция приняла украинские семьи с теплом и морем — но новая жизнь на новом месте не всегда снимает тревогу о доме, о близких, о будущем. Афины и греческие острова дают крышу над головой, но не всегда дают ответ на вопрос "что дальше".</p>
          <p>Вера Владимировна работает онлайн с украинцами по всей Европе уже 35 лет. Через ясновидение и карты Таро она честно смотрит на вашу ситуацию — без запугивания и без лишних обещаний, с теплом и уважением к тому, через что вы прошли.</p>
