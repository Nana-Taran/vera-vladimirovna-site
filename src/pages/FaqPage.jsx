...
const faqs = [
  ...
  },
  {
    ...
    a: 'Вера не использует слово "гарантирую" — потому что работает честно. Она говорит что видит, предлагает работу там, где это уместно, и честно обозначает чего реально ожидать. Это честнее любых гарантий.',
  },
  {
