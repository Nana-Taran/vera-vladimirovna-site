...
const mainText = [
  ...
  'За 35 лет практики через неё прошли сотни ситуаций — отношения, карьера, здоровье, переезды, семейные конфликты, вопросы, которые невозможно обсудить с близкими. Вера умеет слушать и умеет видеть то, что не лежит на поверхности.',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Вера работает без очереди и без записи за несколько недель вперёд. Конкретное время ответа зависит от её расписания на момент обращения. Обычно всё происходит достаточно оперативно.',
  },
  {
      ...
      <section className="pt-32 pb-16 px-4" style={{ background: 'var(--bg-deep)' }}>
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            ...
            >
              Пишете в мессенджер — получаете честный разбор вашей ситуации. Без записи, без ожидания.
            </p>
            <a
              href={TG}
              target="_blank"
