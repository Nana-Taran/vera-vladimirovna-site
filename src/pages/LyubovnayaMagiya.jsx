...
const mainText = [
  ...
  'Вера не даёт пустых обещаний и не говорит "верну за 3 дня". Она работает с ситуацией — и это честнее, чем красивые слова без основания.',
...
const faqs = [
  {
    ...
    a: 'Вера не использует формулировок типа "верну" или "привяжу навсегда" — потому что работает честно. Она смотрит ситуацию, оценивает что реально возможно, и предлагает работу там, где она может дать результат. Иногда это воссоединение. Иногда — помочь человеку отпустить и двигаться дальше.',
  },
  {
