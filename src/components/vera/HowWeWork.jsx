...
const steps = [
  {
    num: '01',
    title: 'Вы пишете',
    text: 'Описываете ситуацию своими словами — что происходит, что вас беспокоит',
  },
  {
    num: '02',
    title: 'Вера смотрит',
    text: 'Через ясновидение или карты — получает картину вашей ситуации',
  },
  {
    num: '03',
    title: 'Выбираете формат',
    text: 'Подходящий именно для вашей ситуации и запроса',
  },
  {
    num: '04',
    title: 'Договариваетесь',
    text: 'Обсуждаете условия и следующие шаги вместе',
  },
];
